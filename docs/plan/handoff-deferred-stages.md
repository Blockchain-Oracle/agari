...
Every deferred feature gets built in full, with the full money gate, to the same quality as the rest. Done so far: S11 Blinks, S10b Range + Moonshot, S8 Earn, S10a Parlay, S9 agents and strategies, S10c Boost, S10d Private desk, S12b Duel arena. **Remaining: S12a's off-chain games wherever they still run on stubs.** The off-chain games are next. Start the next one without asking.
