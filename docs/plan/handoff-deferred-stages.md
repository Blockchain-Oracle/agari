...
Every deferred feature gets built in full, with the full money gate, to the same quality as the rest. Done so far: S11 Blinks, S10b Range + Moonshot, S8 Earn, S10a Parlay, S9 agents and strategies, S10c Boost, S10d Private desk. **Remaining, all to be built: S12b Duel arena (the arena program + `game-room` and `duel-settler`), and S12a's off-chain games where they still run on stubs.** The arena is next. Start the next one without asking.
