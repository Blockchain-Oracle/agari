...
/**
 * `/leaderboard` — web's LeaderboardScreen + LeaderboardBoard: the hero with the live next-close seal, the scope, period
 * and ticker filters, the podium, the field of ranks four to fifty, and the sticky bar with your own rank.
 */
export function LeaderboardScreen() {
  ...
  const showYou = scope === "all" && address !== null && data !== null;
  ...
  return (
    <Screen title={LEADERBOARD.title} scroll={false}>
      ...
      >
        ...
        <BoardFilters board={board} onBoard={setBoard} scope={scope} onScope={setScope} meta={meta} />
        ...
        {scope === "friends" ? (
          <View style={styles.section}>
            <SectionHeader index={LEADERBOARD.friends.number} title={LEADERBOARD.friends.title} desc={LEADERBOARD.friends.desc} />
            <FriendsBoard />
          </View>
        ) : (
          <>
