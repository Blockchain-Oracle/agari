...
const styles = StyleSheet.create({
  ...
  hint: { position: "absolute", alignSelf: "center", bottom: 98, flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 12, height: 30, borderRadius: RADIUS.full, borderWidth: StyleSheet.hairlineWidth },
