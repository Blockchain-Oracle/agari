...
export const card = StyleSheet.create({
  ...
  ticker: { fontFamily: FONT.bodyStrong, fontSize: 14, lineHeight: 22.4, letterSpacing: 0.28 },
  ...
  question: { fontFamily: FONT.heading, fontSize: 15, lineHeight: 18.75, letterSpacing: -0.3 },
