...
export const xs = StyleSheet.create({
  ...
  slabTitle: { fontFamily: FONT.bodyStrong, fontSize: 13, lineHeight: 20.8 },
  ...
  btnVText: { fontFamily: FONT.bodyStrong, fontSize: 14, lineHeight: 22.4 },
  ...
  btnInkText: { fontFamily: FONT.bodyStrong, fontSize: 12, lineHeight: 19.2 },
