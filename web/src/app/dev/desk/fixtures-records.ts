...
const EVIDENCE = (premiumBps: number, costBps: number | null): DeskRecordBody["evidence"] => [
  { id: "e1", kind: "session", market: "24/7", at: iso(NOW_SEC - 1400), trigger: "hourly", nextCheck: iso(NOW_SEC + 2200) },
  { id: "e2", kind: "price", spot: "104.64276840", mean30m: "104.51", gapBps: 13, inLine: true, mark: "101.90", premiumBps, index: null, indexPremiumBps: null, referenceAgeSec: 41, multiplier: "1" },
