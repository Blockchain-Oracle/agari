...
export type ReelItem = { kind: "market"; market: EventMarket } | { kind: "take"; take: FeedTake } | { kind: "holding"; pick: HedgePick };
 ...
 */
export function weaveReel(rounds: readonly EventMarket[], takes: readonly FeedTake[], holdings: readonly HedgePick[] = []): ReelItem[] {
  const out: ReelItem[] = [];
