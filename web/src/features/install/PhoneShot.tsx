 ...
 * rather than as built. So this is a real capture of Agari's `/markets` at a phone viewport,
 * straight off the browser, at `public/demo/bet-screen.png` (780×1688 — a 390×844 viewport at 2×,
 * the same 1:2.164 a phone screen has; taken 2026-09-15 after the close, so it shows the closed
 * board). TO REPLACE: capture again at that viewport and drop it in.
 *
  ...
  return (
    <div className="dl-phone">
      ...
      <div className="dl-phone-screen">
        ...
        <img src="/demo/bet-screen.png" alt={INSTALL.shotAlt} width={780} height={1688} />
