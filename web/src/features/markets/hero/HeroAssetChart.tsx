 ...
 */
export function HeroAssetChartView({ asset, tickers, onPickAsset, session, history, nowSec, range, onRange, onSelect }: HeroAssetChartViewProps) {
  ...
  return (
    <div className="hero-chart" data-asset={asset}>
      ...
      <div className="hero-chart-foot">
        ...
        {onSelect && <ScheduleCallButton asset={asset} session={session} nowSec={nowSec} onSelect={onSelect} variant="foot" opensSec={session.status.nextOpenSec} />}
      </div>
    </div>
  );
}
...
export function HeroAssetChart({ asset, tickers, onPickAsset, onSelect }: HeroAssetChartProps) {
  ...
  return <HeroAssetChartView asset={asset} tickers={tickers} onPickAsset={onPickAsset} session={session} history={history} nowSec={nowSec} range={range} onRange={setRange} onSelect={onSelect} />;
}
