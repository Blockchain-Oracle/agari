...
export const DEMO = {
  ...
  sections: {
    ...
    verify: {
      ...
      body: "Every receipt here opens on Solana Explorer (devnet).",
      readOn: (wallet: string, date: string) => `Agari devnet wallet ${wallet} · successful receipts verified on ${date}. These record completed actions, not current permission or settled winnings.`,
      pending: "Not deployed yet: receipts and program links appear once agari-events is live on devnet.",
