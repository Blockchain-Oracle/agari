...
export const PITCH = {
  ...
  proof: {
    ...
    emph: "open",
    lead: "Prints from three signed sources, fills that mint a pair and fills that burn one, a cross-check settlement, both kinds of void, and the redemptions after them — each one sent to Solana devnet and written into the acceptance ledger with its explorer link, the failures beside the successes.",
