...
See [Halts and voids](/trading/halts-and-voids) for the honest labels the app uses for each of these, and every one of these transactions with its explorer link in the repository's `docs/plan/acceptance.md`.
